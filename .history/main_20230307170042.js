...
// info-nhóm
const infoBtns = document.querySelectorAll('.js-')
const modalInfo = document.querySelector('.js-show_info')
function showModalIifo() {
    modalInfo.classList.add('open')
    modal1.classList.remove('open')
}
for (const regBtn of regBtns) {
    regBtn.addEventListener('click', showModalInfo)
}


// close register
const closeInfoBtn = document.querySelector('.js-close')
function hideBtn(){
...
// close when click outward
const authFormsInfo = document.querySelectorAll('.js-auth-form')
